# 🧩 Структура базы данных проекта «Система Управления Библиотекой (СУБ)»
...
![ER-диаграмма базы данных](https://github.com/Ntditl/kpfu_service_library/blob/main/docs/erm_diagram_bd.png)
